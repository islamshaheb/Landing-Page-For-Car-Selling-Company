...
function TemplatesScreen({ reference }: any) {
      ...
      >
        <div className='TemplateContainer'>
          ...
          <div
            onMouseOver={MouseOver}
            onMouseOut={MouseOut}
            onClick={() => window.open('http://test.customer2.foyob.com/', '_blank')}
            className='link'
          >
            <div
              style={{
        ...
        <div className='TemplateContainer'>
          ...
          <div
            onMouseOver={MouseOver2}
            onMouseOut={MouseOut2}
            onClick={() => window.open('http://test.customer1.foyob.com/', '_blank')}
            className='link'
          >
            <div
              style={{
